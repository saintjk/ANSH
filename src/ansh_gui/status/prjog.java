 ...
 * @author ninslab
 */
public class prjog extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT p FROM ProjectOnGoing p");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                prjog.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                prjog.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                prjog.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                prjog.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<ansh_gui.status.ProjectOnGoing> toRemove = new ArrayList<ansh_gui.status.ProjectOnGoing>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            ansh_gui.status.ProjectOnGoing p = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(p);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        ansh_gui.status.ProjectOnGoing p = new ansh_gui.status.ProjectOnGoing();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<ansh_gui.status.ProjectOnGoing> merged = new ArrayList<ansh_gui.status.ProjectOnGoing>(list.size());
            for (ansh_gui.status.ProjectOnGoing p : list) {
    ...
    private java.util.List<ansh_gui.status.ProjectOnGoing> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(prjog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new prjog());
