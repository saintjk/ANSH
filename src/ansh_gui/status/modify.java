...
public class modify extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ppr1 = new ansh_gui.status.ppr();
        prj1 = new ansh_gui.status.prj();
        prjog1 = new ansh_gui.status.prjog();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jTabbedPane1.addTab("Paper", ppr1);
        jTabbedPane1.addTab("Project", prj1);
        jTabbedPane1.addTab("Project(OnGoing)", prjog1);
    ...
    private ansh_gui.status.ppr ppr1;
    private ansh_gui.status.prj prj1;
    private ansh_gui.status.prjog prjog1;
